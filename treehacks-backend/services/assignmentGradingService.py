...
#     problems = await split_into_questions(problem_text, True)
#     answers = await split_into_questions(answer_text, False)
...
#         submission_text = extract_text_from_pdf(submission_pdf_path)
        
#         # Match questions with answers
#         question_answer_pairs = await match_questions_and_answers(
#             problem_text,
#             submission_text
#         )
...
#         return scores, calculate_total_score(grading_results), grading_results
